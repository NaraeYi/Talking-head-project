...
class StreamSDK:
    ...
    def setup(self, source_path, output_path, **kwargs):
        ...
        # writer_light 변경
        # self.writer = VideoWriterByImageIO(
        #     self.tmp_output_path,
        #     vcodec="libx264",
        #     crf=23,                 # 18 -> 23~28로 올리면 빨라짐(품질↓)
        #     preset="superfast",     # veryfast/superfast/ultrafast 중 선택
        #     tune="zerolatency",     # 지연/버퍼 줄이기
        #     threads=8,              # 서버 코어수에 맞춰 8/16 등 실험
        # )
