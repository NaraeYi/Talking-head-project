...
class TensorRTPredictor:
    ...
    def __init__(self, **kwargs):
        ...
        if platform.system().lower() == 'linux':
            # ctypes.CDLL("/workspace/ditto/ditto-talkinghead-train/checkpoints/liveportrait_onnx/libgrid_sample_3d_plugin.so", mode=ctypes.RTLD_GLOBAL)
            plugin_path = kwargs.get("plugin_path", "/workspace/ditto/ditto-talkinghead-train/checkpoints/liveportrait_onnx/libgrid_sample_3d_plugin.so")
