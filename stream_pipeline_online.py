...
class StreamSDK:
    ...
    def setup(self, source_path, output_path, **kwargs):
        ...
        self.max_size = kwargs.get("max_size", 1920)    # 1920는 full-body/ 512 (talking-head)에 맞는 크기
        ...
        self.sampling_timesteps = kwargs.get("sampling_timesteps", 50) # 10 # 
        self.online_mode = True # kwargs.get("online_mode", False) # True #
    ...
    def _writer_worker(self):
        while not self.stop_event.is_set():
            ...
            self.timing_stats['writer_per_frame_ms'].append(t_elapsed)  # per frame time for writer
            self.timing_stats['writer_total_ms'] += t_elapsed  # total time for writer
    ...
    def _audio2motion_worker(self):
        ...
        while not self.stop_event.is_set():
            ...
            while True:
                ...
                self.timing_stats['dit_total_ms'] += chunk_elapsed
