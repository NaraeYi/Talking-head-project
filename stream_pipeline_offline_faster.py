...
from core.atomic_components.fasterLP_predictor import TensorRTPredictor # NEW
...
class StreamSDK:
    def __init__(self, cfg_pkl, data_root, use_meanflow, meanflow_mode="improved", **kwargs):
        ...
        self.trt_renderer = TensorRTPredictor(
            ...
            # device="cuda",   # predictor 구현에 따라 다를 수 있음
        )
        ...
        self.timing_stats = {
            ...
            'trt_render_total_ms': 0.0,  # total time for trt render
    ...
    def setup(self, source_path, output_path, **kwargs):
        ...
        # 매 setup마다 타이밍 초기화 / timing_stats 초기화는 thread.start() 전에
        self.timing_stats = {
            'audio2feat_total_ms': 0.0,  # total time for wav2feat (HuBERT)
            'audio2feat_per_step_ms': [],
            'dit_total_ms': 0.0,     # total time for audio2motion
        ...
        self.thread_list = [
            ...
            threading.Thread(target=self.trt_render_worker),  # NEW
